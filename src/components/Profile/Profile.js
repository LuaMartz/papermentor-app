                ...
                <div className="frame">
                            ...
                            <div className="div-wrapper">
                                <div className="div">
                                    ...
                                    <div className="subitems">
                                        <div className="div-2">
                                            <img className="img-2" alt="Presentation board" src="presentation-board.svg" />
                                        ...
                                        <div className="div-2">
                                            <img className="img-2" alt="Profile" src="profile.svg" />
                                            <div className="text-2">
                    ...
                    <div className="frame-2">
                        ...
                        <div className="frame-3">
                            <img className="img" alt="Profile" src="image.svg" />
